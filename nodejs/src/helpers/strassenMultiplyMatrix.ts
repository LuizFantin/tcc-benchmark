...
async function strassenMatrixMultiply(A: number[][], B: number[][]) : Promise<number[][]>{
    const n = A.length;
  ...
  function strassenRecursive(A: number[][], B: number[][]) : number[][] {
    const n = A.length;
  ...
  function padMatrix(matrix: number[][], size: number) : number[][] {
  ...
  function trimMatrix(matrix: number[][], size: number) : number[][] {
  ...
  function standardMatrixMultiply(A: number[][], B: number[][]) {
    const n = A.length;
    const C = new Array(n);
    for (let i = 0; i < n; i++) {
      C[i] = new Array(n);
  ...
  function matrixAddition(A: number[][], B: number[][]) : number[][] {
    const n = A.length;
    const C = new Array(n);
    for (let i = 0; i < n; i++) {
      C[i] = new Array(n);
  ...
  function matrixSubtraction(A: number[][], B: number[][]) : number[][] {
    const n = A.length;
    const C = new Array(n);
    for (let i = 0; i < n; i++) {
      C[i] = new Array(n);
 ...
 export default strassenMatrixMultiply;