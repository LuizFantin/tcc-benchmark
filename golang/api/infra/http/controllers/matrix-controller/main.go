...
func Multiply(c *gin.Context) {
	...
	log.Print("Multiplication: ", gin.H{"algorith": algorithm, "result": result[0][0], "m1": m1[0][0], "m2": m2[0][0]})
	c.JSON(http.StatusOK, gin.H{"algorith": algorithm, "result": result[0][0], "m1": m1[0][0], "m2": m2[0][0]})
}
